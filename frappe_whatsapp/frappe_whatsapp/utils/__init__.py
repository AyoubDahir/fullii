...
def trigger_whatsapp_notifications(event):
    ...
    # frappe.throw(data)
    # Convert the document to a dictionary and then to JSON
    # data_dict = data.as_dict()
    # data_json = json.dumps(data_dict, default=str)  # Use `default=str` to handle non-serializable data types like datetime

    # # You can now use or print the JSON data
    # frappe.throw(data_json)
    pass
